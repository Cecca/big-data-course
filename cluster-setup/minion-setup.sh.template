...
# Dump the frontent IP in /etc/frontend-ip
echo %ipv4% > /etc/frontend-ip
...
# Setup with ansible
apt install python-pip && pip install ansible

ansible-pull -U root@%ipv4%:/var/git/config.git -C master --accept-host-key --full --purge
